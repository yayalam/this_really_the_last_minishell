...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/01 01:21:50 by ylambark          #+#    #+#             */
/*   Updated: 2022/12/01 01:21:51 by ylambark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	main_execute(t_one_node_tree *node, char ***env, int cmds_number, \
					t_one_element *lexer_head)
{
	...
	else if (node->type == PIPE)
	{
		...
		if (node->content->pipe->right->type == CMD)
			swap_fd_var(&node->content->pipe->right->content-> \
						cmd->fd.out, fd[1]);
